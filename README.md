...
<details>
  <summary>자기소개</summary>
        ...
        첫 회사에 입사 당시 스프링에 대한 이해가 많이 부족한 상태에서 입사해서 많은 노력 끝에 현재는 개발 팀 내에서 자바, 스프링 관련 지식들을 공부 후 전파하고있으며, 
   </br>    
       'Swagger 를 통한 API 문서화 도입' 및 '커밋 메시지 규칙 도입', '신입 개발자 교육', '각종 정보 문서화' 등을 행하였으며, 핵심 개발자로 자리잡고있습니다.
   </br>
